...
class MemberCreate(Screen):
    def __init__(self, **kwargs):
        ...
        self.cancel_button = Button(text='Cancelar/Voltar')
        self.cancel_button.bind(on_press=self.cancel)
        self.layout.add_widget(self.cancel_button)

    def save_member(self, instance):
        member_data = self.controller.create_member(self.name_input.text)
        self.manager.current = 'member_list'
        self.manager.get_screen('member_list')
